...
public class CourseDetailsFunctionality extends BaseUi{
	...
	public void filterLanguage(String language) {
		...
		//driver.findElement(By.xpath(config.getProperty("showAll"))).click();  //skipping showall
		//Select the language
		List<WebElement> languages = driver.findElements(By.xpath(config.getProperty("languageList")));
		//List<WebElement> languages = driver.findElements(By.xpath("//div[@class='rc-SearchFilterOption']"));
		snap("Language List");
		for (WebElement i : languages) {
			String choice=i.getAttribute("value");
			if(language.equalsIgnoreCase(choice)) {
					i.click();
					break;
					}
		}
		//driver.findElement(By.xpath("//body/div[@id='__next']/div[1]/main[1]/div[1]/div[1]/div[1]/div[2]/main[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[3]/div[1]/div[2]/div[2]/div[1]/div[1]/button[1]/label[1]/input[1]")).click();
